...
<body>
	...
	<div id="contenedorGeneral">
		...
		<div class="hr"><hr /></div>
			...
			<div id="opciones">
				<input type="button" value="Nuevo Provee." id="nuevo" class="opcion" />
				<input type="button" value="Editar Provee." id="editar" class="opcion" />
				<input type="button" value="Elimin Provee." id="eliminar" class="opcion" />		
