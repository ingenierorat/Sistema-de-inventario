$(document).ready(function(){	
	...
	$("#nuevo").click(function(){
		...
		$("#ingreso").text("Registrar cliente al Sistema");
		...
		$("#ingresar").click(function(){
			...
			var dato = {nuevo : nuevo, codigo: codigo, nombre: nombre, apellidos: apellidos, telefono: telefono, mail: mail,
						direccion: direccion, cedula: cedula, sexo: sexo, fecha_ingreso: fecha_ingreso};				
	...
	$("#editar").click(function(){				 
		...
		$("#guardar").click(function(){	
			...
			// Array de tipo json para ser enviado
			var dato = {editar : editar, codigo: codigo, nombre: nombre, apellidos: apellidos, telefono: telefono,
						 mail: mail, direccion: direccion, cedula: cedula, sexo: sexo, fecha_ingreso: fecha_ingreso };				
...
function nuevoClien(){
	...
	tabla += "<tr><td><label class='lbl_registro'>Direccion: </label><textarea name='direccion' id='ddireccion'></textarea></td></tr>";
	...
	$("#tablaRegistroClien").html(tabla);
	// Borra el contenido que haya escrito en el panel
	$("#tablaRegistroEliminar").html("");	

	// Crear los buttones
	buttones = "<input type='button' value='Ingresar Clien.' id='ingresar' />";
...
function editarClien(){
	...
	// Creación de la tabla Pro
	tabla += "<tr><td><label class='lbl_registro'>Id: </label><input type='number' name='id' id='did' placeholder='Código' /></td></tr>";
	tabla += "<tr><td><label class='lbl_registro'>Nombre: </label><input type='text' name='nombre' id='dnombre' /></td></tr>";	
	tabla += "<tr><td><label class='lbl_registro'>Apellidos: </label><input type='text' name='apellidos' id='dapellidos' /></td></tr>";			
	tabla += "<tr><td><label class='lbl_registro'>Teléfono: </label><input type='text' name='telefono' id='dtelefono' /></td></tr>";
	tabla += "<tr><td><label class='lbl_registro'>Mail: </label><input type='text' name='mail' id='dmail' /></td></tr>";
...
function eliminarClien(){
	...
	tabla += "<tr><td><input type='button' name='eliminar' id='deeliminar' value='Eliminar Clien' /><label id='msj'></label></td></tr>";	
		
	// Escribir la tabla creada en la página que la llamó
	$("#tablaRegistroEliminar").html(tabla);	
	// Borra el contenido que haya en el panel
	$("#tablaRegistroClien").html("");
