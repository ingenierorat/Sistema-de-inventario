...
<body>
	...
	<div id="contenedorGeneral">
		...
		<div class="hr"><hr /></div>
			...
			<div id="opciones">
				<input type="button" value="Nueva Cat." id="nuevo" class="opcion" />
				<input type="button" value="Editar Cat." id="editar" class="opcion" />
				<input type="button" value="Elimin Cat." id="eliminar" class="opcion" />		
