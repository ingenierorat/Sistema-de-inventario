$(document).ready(function(){	
	...
	$("#nuevo").click(function(){ 
		// Llamar la funcion que creará la tabla para infresar las nuevac categoria
		nuevaCat();
		// Poner el focus el primer campo  
		$("#did").focus();
		// Cambiar el texto de este DIV
		$("#ingreso").text("Registrar Categoría al Sistema");

		$("#ingresar").click(function(){
			
			alert("Hola prubaffff");
			...
			.done(function(dato){
				...
				if (dato == 1) {
					...
					$("#msj").html("Registro insertado Exitoso");
					setTimeout(function(){
				 	...
				 	if (dato== -1) {
				 		...
				 		$("#msj").html('Registro no Insertado');
				 		setTimeout(function(){
	...
	$("#editar").click(function(){				
		...
		$("#did").focus();
		// Cambiar el texto de este DIV
		$("#ingreso").text("Editar Categoría del Sistema");
...
function nuevaCat(){
	...
	$("#tablaRegistroCat").html(tabla);	
	// Borra los datos de la tabla
	$("#tablaRegistroEliminar").html("");

	// Crear los buttones
	buttones = "<input type='button' value='Ingresar Cat.' id='ingresar' />";
...
function eliminarCat(){
	...
	tabla += "<tr><td><input type='button' name='eliminar' id='deeliminar' value='Eliminar Cat' /><label id='msj'></label></td></tr>";	
		
	// Escribir la tabla creada en la página que la llamó
	$("#tablaRegistroEliminar").html(tabla);	
	// Borra el contenido que haya en el panel
	$("#tablaRegistroCat").html("");
