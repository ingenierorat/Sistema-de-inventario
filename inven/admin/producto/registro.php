...
<body>
	...
	<div id="contenedorGeneral">
		...
		<div class="hr"><hr /></div>
			...
			<div id="opciones">
				<input type="button" value="Nuevo Pro." id="nuevo" class="opcion" />
				<input type="button" value="Editar Pro." id="editar" class="opcion" />
				<input type="button" value="Eliminar Pro." id="eliminar" class="opcion" />		
