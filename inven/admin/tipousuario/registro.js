$(document).ready(function(){	
	...
	$("#nuevo").click(function(){ 
		...
		$("#ingreso").text("Registrar Tipo Usuario al Sistema");
	...
	$("#editar").click(function(){				
		...
		$("#did").focus();
		// Cambiar el texto de este DIV
		$("#ingreso").text("Editar Tipo Usuario del Sistema");
...
function nuevoTipoUsua(){
	...
	$("#tablaRegistroTipoUsua").html(tabla);
	// Borrar datos de la tabla
	$("#tablaRegistroEliminar").html("");	

	// Crear los buttones
	buttones = "<input type='button' value='Ingresar TUsua.' id='ingresar' />";
...
// Eliminar tipo usuario del Sistema
function eliminarTipoUsua(){
	...
	tabla += "<tr><td><input type='button' name='eliminar' id='deeliminar' value='Eliminar TUsua' /><label id='msj'></label></td></tr>";	
		
	// Escribir la tabla creada en la página que la llamó
	$("#tablaRegistroEliminar").html(tabla);	
	// Borra el contenido que haya en el panel
	$("#tablaRegistroTipoUsua").html("");
