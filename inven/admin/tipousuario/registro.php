...
<head>
	<meta charset="UTF-8">
	<title>Registro de Tipo Usuario.</title>
...
<body>
	...
	<div id="contenedorGeneral">
		...
		<div id="frmRegistro">
			...
			<table id="tablaRegistroTipoUsua">
			</table>
		...
		<div class="hr"><hr /></div>
			...
			<div id="opciones">
				<input type="button" value="Nuevo TUsua." id="nuevo" class="opcion" />
				<input type="button" value="Editar TUsua." id="editar" class="opcion" />
				<input type="button" value="Elimin TUsua." id="eliminar" class="opcion" />		
