...
<body> 
	...
	<div id="contenedorGeneral">
		...
		<div class="hr"><hr /></div>
			...
			<div id="opciones">
				<input type="button" value="Nuevo Usua." id="nuevo" class="opcion" />
				<input type="button" value="Editar Usua." id="editar" class="opcion" />
				<input type="button" value="Eliminar Usua." id="eliminar" class="opcion" />		
