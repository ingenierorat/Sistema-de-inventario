...
<body>
	...
	<div id="contenedorGeneral">
		...
		<div class="hr"><hr /></div>
			...
			<div id="opciones">
				<input type="button" value="Nuevo Pago." id="nuevo" class="opcion" />
				<input type="button" value="Editar Pago." id="editar" class="opcion" />
				<input type="button" value="Elimin Pago." id="eliminar" class="opcion" />		
