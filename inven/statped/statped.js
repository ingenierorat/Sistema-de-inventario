...
function buscarIdPedido(){
	...
	.done(function(dato){
		...
		if (dato == -1) {
			...
			$("#lblopcion").html("Pedido no encontrado");
			$("#lblopcion").css("color","red");
			$("#txtbuscar").focus();
			setTimeout(function(){
			...
			$("#contenedorTablaStatped").html(dato);
...
function buscarIdProducto(){
	...
	.done(function(dato){
		...
		if (dato == -1) {
			...
			$("#lblopcion").html("Producto sin pedido aún");
			$("#lblopcion").css("color","red");
			$("#txtbuscar").focus();
			setTimeout(function(){
...
function buscarTodo(limite){
	...
	.done(function(dato){
		...
		if (dato == -1) {
			...
			$("#lblopcion").html("No hay pedidos realizados aún");
			$("#lblopcion").css("color","red");
			$("#txtbuscar").focus();
			setTimeout(function(){
